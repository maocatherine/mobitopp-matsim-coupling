...
public class ExternalTrips {
    ...
    private Location selectLocationIn(Zone origin) {
       return origin
               .opportunities()
               .selectRandomLocation(ActivityType.SHOPPING, rnd_location.nextDouble());
    }

    private boolean hasOpportunities(Zone origin) {
        return origin.opportunities().locationsAvailable();
    }
